...
export type Domain = {
  ...
  shortName?: string;
  /** The named layer a domain's products sit under, e.g. "Bi-Scitense". */
  subLayer?: string;
...
export const products: readonly Product[] = [
  ...
  { name: "CellAbGen", slug: "cellabgen", domain: "research", group: "Design", oneLiner: TODO_LINE, status: "in-lab" },
  { name: "Cimmexa", slug: "cimmexa", domain: "research", group: "Design", oneLiner: TODO_LINE, status: "in-lab" },
  { name: "CellInfo", slug: "cellinfo", domain: "research", group: "Design", oneLiner: TODO_LINE, status: "in-lab" },

  // Research › Bi-Scitense › Discovery
